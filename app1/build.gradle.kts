...
android {
    namespace = "com.walhalla.meccamedina"
    ...
    if (versionPropsFile.canRead()) {
        ...
        defaultConfig {
            ...
            applicationId = "com.walhalla.meccamedina"
            ...
            setProperty("archivesBaseName", "meccamedina-old")
//            manifestPlaceholders = mapOf(
//                "onesignal_app_id" to "8fcf9ed0-0064-49ee-9d27-aca9bb3bd972",
