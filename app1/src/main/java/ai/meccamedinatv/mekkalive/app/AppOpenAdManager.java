package ai.meccamedinatv.mekkalive.app;
...
public class AppOpenAdManager {
    ...
    public void showAdIfAvailable(
            ...
            @NonNull DexApplication.OnShowAdCompleteListener onShowAdCompleteListener0) {
        ...
        if (!isAdAvailable()) {
            DLog.d("The app open ad is not ready yet.");
        ...
        appOpenAd.setFullScreenContentCallback(
                new FullScreenContentCallback() {
                    ...
                    public void onAdFailedToShowFullScreenContent(
                        ...
                        DLog.d("onAdFailedToShowFullScreenContent: " + adError.getMessage());
                        onShowAdCompleteListener0.onShowAdComplete();
                        loadAd(activity);
                    }
