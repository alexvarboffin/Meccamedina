...
class YoutubeRepository(context: Context, youTube: YouTube) :
    AbstractYoutubeRepository(youTube, Const.GOOGLE_API_KEY) {
...
//        });
    ...
    //    public void getDurationAsync(List<String> ids, Callback<VideoListResponse> callback) {
