package ai.meccamedinatv.mekkalive.online
...
class DexApplication : MultiDexApplication(), Application.ActivityLifecycleCallbacks,
    ...
    override fun onCreate() {
        ...
        if (!BuildConfig.DEBUG) {
            ...
            list.add("45F1318FD70F9033C4A9DC6F6B56CAE3")
        }
...
//                    .init();
    ...
    companion object {
        ...
        private const val ONESIGNAL_APP_ID = "1b064a29-0b38-4562-aa73-2bc13cd4bf63"

        private var var0: DexApplication? = null
